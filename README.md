...
**Version 5.3** - Aufklappbare Paragraphen | GitHub Auto-Sync | Dunkles Design
...
- **Aufklappbar!** Klick auf Paragraph → zeigt alle Inhalte
...
│                                          │
│ ▼ § 2 Straßenbenutzung                   │  ← Aufgeklappt!
│   🔵StVO 🟢VwV ⚫Erl ⚫Mod  [📝 Bearbeiten]│
│                                          │
│   🔵 StVO Original:                      │
│   (1) Fahrzeuge müssen...                │
│   (2) Es ist rechts zu fahren...         │
│                                          │
│   🟢 VwV-StVO:                            │
│   Zu Absatz 1: Die Vorschrift...         │
└──────────────────────────────────────────┘
```
...
- **Klick auf Paragraph-Zeile** → klappt auf
- Zeigt alle befüllten Spalten
- **Nochmal klicken** → klappt zu
- **Perfekt zum schnellen Durchlesen!**
...
- ✨ **Aufklappbare Paragraphen** - Klick auf Zeile zeigt alle Inhalte
- ✨ Schnelles Durchlesen ohne Bearbeiten-Modal zu öffnen
- 🐛 UTF-8 Encoding Fix - Umlaute (ä ö ü ß) funktionieren jetzt korrekt
- ✨ Farbcodierte Preview-Bereiche

### **v5.2 (2025-12-21)**
- ✨ **GitHub Auto-Sync** - Token-Popup beim ersten Öffnen
- ✨ Sicherer: Token nur im Browser, nicht im Code
- ✨ Status-Anzeige oben rechts (verbunden/speichert/fehler)
- ✨ "❌ Ohne Sync arbeiten" → Offline-Modus
