...
- **Hardcoded** - keine Einstellungen nötig!
- Lädt beim Start automatisch von GitHub
...
```
Tool öffnen → Lädt automatisch von GitHub
Änderungen machen → "🔄 GitHub Sync" klicken
Fertig! Alle im Team haben die neuesten Daten!
```
